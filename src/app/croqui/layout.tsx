...
export default function CroquiLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      <Script id="hub-tracker-croqui" src="https://hub.universoeduk.com/tracker.js" strategy="afterInteractive" />
      <div
        id="offer-root"
        className="laboral-offer croqui-offer"
