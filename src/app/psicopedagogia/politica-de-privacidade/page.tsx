...
export const metadata: Metadata = {
  ...
  description:
    "Política de privacidade do Mapa de Perfil Infantil para Psicopedagogas Iniciantes — proteção de dados pessoais conforme a LGPD (Lei 13.709/2018).",
}
    ...
    <div style={{ background: "var(--bg, #F5F8F0)", minHeight: "100vh", padding: "60px 16px 80px" }}>
      <div style={{ maxWidth: 720, margin: "0 auto", fontFamily: "'Manrope', sans-serif", color: "var(--text, #333)" }}>
        ...
        <Section title="1. Identificação do Responsável">
          <p>
            Esta Política de Privacidade é aplicável ao site <strong>universoeduk.com</strong> e ao produto
            digital <strong>Mapa de Perfil Infantil para Psicopedagogas Iniciantes</strong>, comercializado
            sob a marca <strong>Universo Eduk</strong>, operados por pessoa física com e-mail de contato:{" "}
            <strong>contatouniversoeduk@gmail.com</strong>.
          </p>
        </Section>
