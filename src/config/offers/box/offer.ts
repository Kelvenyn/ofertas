...
export const OFFER: OfferConfig = {
  ...
  hero: {
    ...
    support: "Consulte o guia visual de modelos de box com tijolos e blocos de vidro, do início ao acabamento, sem improvisar na obra.",
    ctaText: "QUERO O GUIA",
    marqueeText: "30 MODELOS DE BOX • 15 COM TIJOLO • 15 EM VIDRO • ACESSO IMEDIATO",
    bullets: [
  ...
  socialProof: {
    title: "Pedreiros já usam o Guia Passo a Passo",
    testimonials: [
      { src: "/images/box/depoimento-01.webp", alt: "Depoimento 1" },
      { src: "/images/box/depoimento-02.webp", alt: "Depoimento 2" },
      { src: "/images/box/depoimento-03.webp", alt: "Depoimento 3" },
      { src: "/images/box/depoimento-04.webp", alt: "Depoimento 4" },
      { src: "/images/box/depoimento-05.webp", alt: "Depoimento 5" },
      { src: "/images/box/depoimento-06.webp", alt: "Depoimento 6" },
    ]
  },
  counter: {
    prefix: "",
    target: 30,
    label: "30 modelos de box para consultar na obra"
  },
  kitCards: {
    heading: "Veja os modelos de box por dentro",
    images: Array.from({ length: 16 }, (_, index) => ({
      src: `/images/box/demonstrativo-${String(index + 1).padStart(2, "0")}.webp`,
      alt: `Modelo de box com tijolos e blocos de vidro ${index + 1}`
    }))
  },
  benefits: {
    title: "Por que pedreiros usam o guia de box?",
    ctaText: "QUERO O GUIA",
    items: [
      { icon: "🧱", title: "Praticidade", desc: "30 modelos visuais para consultar na obra." },
      { icon: "📋", title: "Organização", desc: "Modelos, materiais, nichos e etapas reunidos em um só lugar." },
      { icon: "✅", title: "Segurança", desc: "Consulte modelos novos sem improvisar durante o serviço." },
      { icon: "📈", title: "Oportunidade", desc: "Tenha referências para pedidos de modelos novos." },
    ]
  },
  urgency: {
    title: "Consulte o guia antes do próximo serviço de box",
    highlight: "",
  ...
  deliverables: {
    ...
    bullets: [
      "Guia visual de box com tijolos e blocos de vidro",
      ...
      "Referências de nichos, divisórias e modelos",
  ...
  bonuses: [
    { front: "/images/box/bonus-01-frente.webp", back: "/images/box/bonus-01-verso.webp", title: "+10 Modelos de Box para Banheiros Pequenos", titleBreak: "+10 Modelos de Box\npara Banheiros Pequenos", desc: "Referências visuais para escolher modelos que aproveitem melhor espaços compactos sem prejudicar a circulação." },
    { front: "/images/box/bonus-02-frente.webp", back: "/images/box/bonus-02-verso.webp", title: "+12 Projetos de Nichos Integrados ao Box", titleBreak: "+12 Projetos de Nichos\nIntegrados ao Box", desc: "Projetos de nichos internos, externos, verticais, horizontais e combinados para agregar mais função à divisória." },
    { front: "/images/box/bonus-03-frente.webp", back: "/images/box/bonus-03-verso.webp", title: "Guia Visual de Acabamentos de Quinas, Bordas e Encontros", titleBreak: "Guia Visual de\nAcabamentos", desc: "Referências ampliadas para conferir os detalhes que mais aparecem no resultado final do serviço." },
    { front: "/images/box/bonus-04-frente.webp", back: "/images/box/bonus-04-verso.webp", title: "Ficha de Medição do Banheiro", titleBreak: "Ficha de Medição\ndo Banheiro", desc: "Fichas práticas para registrar medidas, posição da divisória, nichos e interferências antes de começar a obra." },
    { front: "/images/box/bonus-05-frente.webp", back: "/images/box/bonus-05-verso.webp", title: "Lista de Materiais por Tipo de Box", titleBreak: "Lista de Materiais\npor Tipo de Box", desc: "Consulte os materiais por tipo de serviço e organize o que precisa estar separado antes de começar." },
    { front: "/images/box/bonus-06-frente.webp", back: "/images/box/bonus-06-verso.webp", title: "Checklist Final Antes de Entregar ao Cliente", titleBreak: "Checklist Final do Box", desc: "Revise alinhamento, nichos, revestimento, quinas, juntas, limpeza e aparência final antes da entrega." },
  ],
  pricing: {
    titleLead: "ESCOLHA SEU PLANO",
    titleHighlight: "DE BOX",
    note: "Pagamento seguro pela Hotmart. Acesso ao material após a confirmação da compra.",
    plans: [
      {
        id: "basic",
        title: "Plano Básico",
        image: "/images/box/plano-basico.webp",
        imageAlt: "Plano Básico do Guia de Box",
        featured: false,
        oldPrice: "",
        price: "R$ 17,90",
        installments: "Consulte as opções de pagamento no checkout",
        items: ["Guia visual de box com tijolos e blocos de vidro", "15 modelos com tijolos e alvenaria", "15 modelos com blocos de vidro", "Referências de materiais e etapas", "Arquivos para consultar durante a obra", "Acesso após a confirmação da compra"],
      ...
      },
      {
        ...
        price: "R$ 27,90",
        installments: "Consulte as opções de pagamento no checkout",
        items: ["Guia visual de box com tijolos e blocos de vidro", "🎁 +10 modelos de box para banheiros pequenos", "🎁 +12 projetos de nichos para o box", "🎁 Guia visual de acabamentos", "🎁 Ficha de medição do banheiro", "🎁 Lista de materiais por tipo de box", "🎁 Checklist final antes da entrega", "Acesso pelo celular, tablet ou computador"],
  ...
  access: {
    ...
    steps: [
      ...
      { title: "Receba no email", desc: "As instruções chegam diretamente no email cadastrado na compra." },
  ...
  faq: {
    ...
    items: [
      { q: "Como vou receber o Guia Passo a Passo de Box?", a: "Você recebe os arquivos digitais por email logo após a confirmação da compra." },
  ...
  footer: {
    ...
    updateBody: "O guia reúne modelos e referências para consulta durante a obra. A oferta inclui as atualizações futuras disponibilizadas para o material.",
