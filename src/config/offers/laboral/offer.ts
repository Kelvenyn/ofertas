...
export const OFFER: OfferConfig = {
  ...
  hero: {
    ...
    subtitle: "Escolha a dinâmica pelo perfil da equipe, objetivo e tempo disponível — sem criar nada do zero.", ctaText: "QUERO AS DINÂMICAS PRONTAS", marqueeText: "50 DINÂMICAS PRONTAS ✦ PARA FISIOTERAPEUTAS ✦ ADMINISTRATIVO ✦ OPERACIONAL ✦ ", marqueeGradient: "linear-gradient(90deg, #047857 0%, #16A34A 100%)",
  ...
  counter: { prefix: "+ de", target: 50, label: "dinâmicas laborais prontas e organizadas para aplicar" },
  kitCards: { ...psicopedagogiaOffer.kitCards, heading1: "Veja como encontrar a dinâmica certa para cada equipe:" },
  benefits: { title: "Por que fisioterapeutas estão escolhendo as Dinâmicas Laborais Prontas?", ctaText: "QUERO AS DINÂMICAS PRONTAS", items: [
    ...
    { icon: "💼", title: "Mais engajamento", desc: "Quebre a resistência e conduza sessões mais participativas, mesmo com colaboradores desmotivados." },
  ] },
  urgency: { pill: "OPORTUNIDADE ÚNICA", title: "Chegue à próxima sessão com uma dinâmica pronta para aplicar", highlight: "", body: "Você já conhece os exercícios técnicos. Agora tenha um repertório para quebrar a monotonia, envolver o grupo e escolher a dinâmica certa sem improvisar.", ctaText: "QUERO ACESSAR AGORA", trust: ["ACESSO IMEDIATO • ACESSO VITALÍCIO"] },
  idealPara: { pill: "É PARA VOCÊ", title: "Este material é ideal para fisioterapeutas que desejam:", subtitle: "Mais repertório, menos planejamento e sessões mais dinâmicas nas empresas.", items: [
    { icon: "🏢", title: "Atender equipes", desc: "Ter opções para colaboradores administrativos e operacionais." }, { icon: "⚡", title: "Ganhar agilidade", desc: "Encontrar a atividade certa em poucos minutos antes do atendimento." }, { icon: "🧩", title: "Variar sessões", desc: "Escolher por objetivo, formato e ocasião sem repetir a mesma dinâmica." }, { icon: "✅", title: "Conduzir com segurança", desc: "Ter passo a passo, comandos e adaptações para aplicar em cada empresa." },
  ] },
  deliverables: { ...psicopedagogiaOffer.deliverables, pill: "ACESSO IMEDIATO", title: "Tudo o que você vai receber", imageAlt: "Dinâmicas Laborais Prontas", bullets: ["50 dinâmicas completas de ginástica laboral", "25 dinâmicas para equipe administrativa", "25 dinâmicas para equipe operacional", "Dinâmicas de 5, 10 e 15 minutos", "Objetivo, perfil, formato de participação e passo a passo", "Materiais simples, comandos, adaptações e cuidados de aplicação", "PDFs para celular, tablet, computador ou impressão"] },
