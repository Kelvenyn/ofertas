...
export const OFFER: OfferConfig = {
  ...
  hero: {
    ...
    pill: "PARA PROFESSORES DE GINÁSTICA LABORAL", headline: "50 Dinâmicas Prontas\nde Ginástica Laboral", subline: "Para engajar até os colaboradores mais resistentes, do operacional ao administrativo, sem precisar pesquisar nada na internet.", image: laboralImage(psicopedagogiaOffer.hero.image), imageAlt: "50 Dinâmicas Prontas de Ginástica Laboral",
    support: "Identifique o perfil da equipe, escolha o objetivo do momento de acordo com o tempo disponível e aplique a dinâmica certa.", ctaText: "QUERO AS DINÂMICAS PRONTAS", marqueeText: "50 DINÂMICAS PRONTAS ✦ ADMINISTRATIVO ✦ OPERACIONAL ✦ ACESSO IMEDIATO ✦ ", bullets: ["Dinâmicas adequadas a cada perfil de equipe", "Organizadas por objetivo, para encontrar rapidamente", "Opções para aplicações de 5, 10 e 15 minutos", "Material prático para consultar pelo celular ou imprimir"]
  },
  ...
  kitCards: { ...psicopedagogiaOffer.kitCards, heading: "Veja como encontrar a dinâmica certa para cada momento:", images: psicopedagogiaOffer.kitCards.images.map((image) => ({ ...image, src: laboralImage(image.src) })) },
  ...
  urgency: { title: "Leve sempre uma dinâmica pronta para a próxima sessão", highlight: "", body: "Você já domina a parte técnica. Falta um repertório pronto para escolher, abrir e aplicar com facilidade.", ctaText: "QUERO ACESSAR AGORA", trust: ["ACESSO IMEDIATO • ACESSO VITALÍCIO"] },
  deliverables: { ...psicopedagogiaOffer.deliverables, title: "Tudo o que você vai receber", image: laboralImage(psicopedagogiaOffer.deliverables.image), imageAlt: "Dinâmicas Laborais Prontas", bullets: ["50 dinâmicas completas de ginástica laboral", "25 dinâmicas para equipe administrativa", "25 dinâmicas para equipe operacional", "Dinâmicas de 5, 10 e 15 minutos", "Objetivo, formato de participação e passo a passo de cada dinâmica", "Comandos de condução e sugestões de adaptação", "PDFs para celular, tablet, computador ou impressão"] },
