...
export const OFFER: OfferConfig = {
  ...
  footer: { ...psicopedagogiaOffer.footer, updateTitle: "Material em constante atualização", updateBody: "As Dinâmicas Laborais Prontas recebem melhorias e correções periódicas. Ao adquirir agora, você garante acesso vitalício.", missionText: "Conduza sessões de ginástica laboral com mais variedade, organização e menos improviso", privacyUrl: "/politica-de-privacidade", termsUrl: "/termos-de-uso" },
}
