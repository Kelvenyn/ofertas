...
export const OFFER: OfferConfig = {
  ...
  hero: {
    ...
    subtitle: "Tenha exercícios adequados ao perfil dos colaboradores, ao objetivo da atividade e ao tempo disponível na empresa.",
    ...
    bullets: ["Atividades para diferentes perfis de colaboradores", "Atividades organizadas por região corporal e objetivo", "Opções para aplicações de 5, 10 e 15 minutos", "Material prático para consultar pelo celular ou imprimir"],
  },
