...
export const OFFER: OfferConfig = {
  ...
  socialProof: {
    ...
    testimonials: Array.from({ length: 6 }, (_, index) => ({ src: image(`Depoimento (${index + 1}).webp`), alt: `Depoimento sobre os projetos de áreas de serviço ${index + 1}` }))
  },
  ...
  urgency: {
    title: "Aproveite melhor sua lavanderia com projetos visuais prontos para usar", highlight: "",
  ...
  access: { title: "Como você vai receber seus 50 Projetos de Áreas de Serviço Pequenas", steps: [
    ...
    { title: "Receba no e-mail", desc: "As instruções de acesso chegam diretamente no e-mail cadastrado na compra." },
    { title: "Acesse os materiais", desc: "Tudo organizado em arquivos digitais, pronto para abrir pelo celular, tablet ou computador." },
    { title: "Compare com sua lavanderia", desc: "Abra os projetos, encontre configurações parecidas com o seu espaço e use as referências para planejar suas adaptações." },
  ] },
