...
export const OFFER: OfferConfig = {
  ...
  hero: {
    ...
    marqueeGradient: "linear-gradient(90deg, #9A3412 0%, #C2410C 45%, #EA580C 72%, #9A3412 100%)",
  ...
  urgency: {
    pill: "CONSULTA RÁPIDA", title: "Você limpa seu porcelanato... mas quando ele seca parece que não ficou limpo de verdade?", highlight: "",
  ...
  guarantee: {
    ...base.guarantee, marqueeText: "GARANTIA ✦ COMPRA SEGURA ✦ ACESSO IMEDIATO ✦ GARANTIA ✦ COMPRA SEGURA ✦ ACESSO IMEDIATO", marqueeGradient: "linear-gradient(90deg, #9A3412 0%, #C2410C 50%, #EA580C 100%)", icon: "/images/porcelanato/garantia-30-dias.webp", iconAlt: "Garantia de 30 dias", sealText: undefined,
