...
export const OFFER: OfferConfig = {
  ...
  hero: {
    ...laboralOffer.hero, pill: "AUXILIADORES E VETERINÁRIOS", headline: "Mapa Visual de Preparação\nda Mesa para Castração", subline: "Entre na sala com mais clareza, confiança e segurança em cada procedimento.",
    image: castracaoImage(laboralOffer.hero.image), imageAlt: "Kit visual de preparação da mesa para castração", support: "Você receberá um kit completo com mapas visuais e checklists que facilitam a preparação da mesa cirúrgica", ctaText: "QUERO ACESSAR O KIT", marqueeText: "MAPAS VISUAIS ✦ CHECKLISTS PRONTOS ✦ ACESSO IMEDIATO ✦ PARA CÃES E GATOS ✦ ", bullets: ["Mapas visuais prontos para consulta rápida", "Checklists para cada etapa da preparação", "Materiais organizados por categoria", "Arquivos fáceis de adaptar à rotina da clínica"]
  },
  ...
  kitCards: { ...laboralOffer.kitCards, heading: "Veja os materiais que você vai consultar antes de cada castração:", images: laboralOffer.kitCards.images.map((item) => ({ ...item, src: castracaoImage(item.src), alt: "Material visual do kit de castração" })) },
  ...
  urgency: { title: "Prepare a mesa com segurança antes do próximo procedimento", highlight: "", body: "Tenha um guia visual para conferir a organização da bancada, os instrumentos e os materiais essenciais antes de entrar na sala.", ctaText: "QUERO ACESSAR AGORA", trust: ["ACESSO IMEDIATO", "MATERIAL DIGITAL"] },
  ...
  access: { title: "Como é o acesso ao kit", steps: [
    { title: "Conclua a compra", desc: "Após o pagamento, o acesso é liberado automaticamente." }, { title: "Receba por e-mail", desc: "Você recebe as instruções de acesso no e-mail cadastrado." }, { title: "Baixe os arquivos", desc: "Acesse os materiais pelo computador ou celular e imprima quando precisar." }, { title: "Use e aplique", desc: "Consulte os mapas, siga os checklists e adapte os arquivos à sua rotina." },
  ] },
