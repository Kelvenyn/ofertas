...
export const OFFER: OfferConfig = {
  ...
  bonuses: [
    { front: "/images/lembrancinhas/bonus-1-frente.png", back: "/images/lembrancinhas/bonus-1-verso.webp", title: "Vídeos Aulas de Montagem das Lembrancinhas", titleBreak: "Vídeos Aulas de Montagem\ndas Lembrancinhas", desc: "Aulas em vídeo com orientações passo a passo para montagem, impressão, recorte e finalização de cada lembrancinha.", price: "R$ 19,90" },
