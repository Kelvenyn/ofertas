...
export const OFFER: OfferConfig = {
  ...
  faq: {
    ...
    items: [
      ...
      { q: "Posso usar em diferentes tipos de encontros?", a: "Sim. Os modelos foram organizados para catequese, células, grupos de jovens, pequenos grupos, encontros de mulheres, retiros, ministérios, grupos de oração e outros encontros cristãos." },
      ...
      { q: "Posso imprimir mais de uma vez?", a: "Sim. Você poderá acessar os arquivos novamente e imprimir os modelos sempre que precisar para uso pessoal nos seus encontros, respeitando os termos de uso do material." },
