...
export const OFFER: OfferConfig = {
  ...
  idealPara: {
    ...
    items: [
      { icon: "📱", title: "Tirar do celular", desc: "Você entrega uma alternativa pronta, divertida e bíblica para a criança se concentrar longe da tela, sem gritar, sem implorar." },
      { icon: "📖", title: "Ensinar com leveza", desc: "A criança colore por números e descobre personagens bíblicos com ensinamentos e versículos, sem sentir que está estudando." },
      { icon: "🏠", title: "Criar momentos tranquilos", desc: "Quando a criança pede o celular, você imprime uma Pixel Arte e transforma o tédio em um momento criativo e silencioso." },
      { icon: "🙏", title: "Cultivar a fé", desc: "Enquanto colore, seu filho absorve valores cristãos de forma natural, sem pressão, sem sermão, sem brigas." },
    ],
  },
  deliverables: {
  ...
  bonuses: [
    {
      ...
      title: "Mapas Mentais do AT",
      titleBreak: "Mapas Mentais do AT",
    ...
    },
    {
      ...
      title: "Mapas Mentais do NT",
      titleBreak: "Mapas Mentais do NT",
    ...
    },
    {
      ...
      titleBreak: "Colorir com os Salmos",
    ...
    },
    {
      ...
      titleBreak: "Colorir com os Provérbios",
    ...
    },
    {
      ...
      titleBreak: "Planner de Leitura Bíblica",
    ...
    },
    {
      ...
      titleBreak: "Marcadores de Abas Bíblicas",
