...
export const OFFER: OfferConfig = {
  ...
  socialProof: {
    ...
    testimonials: [
      ...
      { src: "/images/Depoimento (6).webp", alt: "Depoimento 6", gradient: "linear-gradient(90deg, #0A1F44, #16A34A)" },
      { src: "/images/Depoimento (7).webp", alt: "Depoimento 7", gradient: "linear-gradient(90deg, #B0B8C7, #081733)" },
      { src: "/images/Depoimento (8).webp", alt: "Depoimento 8", gradient: "linear-gradient(90deg, #E11D2E, #0A1F44)" },
    ],
  },
  counter: {
    prefix: "+ de",
