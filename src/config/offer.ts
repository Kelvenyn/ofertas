...
export const OFFER: OfferConfig = {
  ...
  hero: {
    ...
    titleLine2: "com + de 100 Pixel Arts",
    titleLine3: "bíblicas para colorir.",
    image: "/images/Plano-Completo.webp",
    imageAlt: "Pixel Art Bíblico",
    imageWidth: 340,
    imageHeight: 425,
    subtitle: "Seu filho colore por números, revela personagens bíblicos\naos poucos e aprende sobre Deus longe das telas, sem brigar, sem complicação, sem culpa.",
  ...
  idealPara: {
    ...
    items: [
      { icon: "📱", title: "Tirar seu filho do celular", desc: "Você entrega uma alternativa pronta, divertida e bíblica para a criança se concentrar longe da tela, sem gritar, sem implorar." },
