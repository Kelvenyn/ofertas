...
export const OFFER: OfferConfig = {
  ...
  benefits: [
    ...
    { icon: "🎯", title: "Mais foco e concentração", desc: "A criança segue os números e pinta os quadradinhos, estimulando atenção, paciência e concentração — sem perceber que está aprendendo." },
    ...
    { icon: "🧠", title: "Criatividade e coordenação", desc: "Pintar por números trabalha coordenação motora, percepção visual, noção de cores e organização — habilidades que duram a vida inteira." },
  ...
  idealPara: {
    ...
    items: [
      { icon: "📱", title: "Tirar seu filho do celular sem brigar", desc: "Você entrega uma alternativa pronta, divertida e bíblica para a criança se concentrar longe da tela — sem gritar, sem implorar." },
      { icon: "⏱️", title: "Ter uma atividade cristã pronta para usar", desc: "O material vem pronto para imprimir. Você escolhe uma arte e entrega para a criança começar em menos de 1 minuto." },
      { icon: "📖", title: "Ensinar sobre Deus de um jeito leve", desc: "A criança colore por números e descobre personagens bíblicos com ensinamentos e versículos — sem sentir que está estudando." },
      { icon: "🏠", title: "Criar momentos mais tranquilos em casa", desc: "Quando a criança pede o celular, você imprime uma Pixel Arte e transforma o tédio em um momento criativo e silencioso." },
      { icon: "🌱", title: "Plantar valores cristãos desde cedo", desc: "Cada arte aproxima a criança de valores como fé, obediência, coragem, amor e confiança em Deus — de forma natural." },
      { icon: "🙏", title: "Cultivar a fé do seu filho sem forçar", desc: "Enquanto colore, seu filho absorve valores cristãos de forma natural, sem pressão, sem sermão, sem brigas." },
    ],
  },
  deliverables: {
